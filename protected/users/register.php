...
<form>
	...
	<div class="form-row">
		<div class ="form-group col-md-6">
			<label for="registerEmail">Email</label>label>
			<input type="email" class="form-cont" id="registerEmail" name="email" value="<?=isset($postData) ? $postData['email'] : "";?>">
		</div>
		<div class="form-group col-md-6">
			<label for="registerEmail1">Ellenőrző Email</label>label>
			<input type="email" class="form-control" id="registerEmail1" name="email1"value="<?=isset($postData) ? $postData['email'] : "";?>">
		</div>
	</div>
